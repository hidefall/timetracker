...
Vue.component('register-chooser', __webpack_require__(43));
Vue.component('projects', __webpack_require__(46));
Vue.component('tasks', __webpack_require__(52));
Vue.component('timeframes', __webpack_require__(55));
Vue.component('timer', __webpack_require__(58));
Vue.component('change-avatarka', __webpack_require__(63));

// REGISTER FORM //
Vue.component('register-handler', __webpack_require__(68));
Vue.component('choose-plan', __webpack_require__(71));
Vue.component('payment', __webpack_require__(74));
Vue.component('finish-registration', __webpack_require__(79));
Vue.component('register-company', __webpack_require__(82));
Vue.component('create-element', __webpack_require__(85));
Vue.component('add-project-form', __webpack_require__(90));
// ------------- //
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        submitForm: function submitForm() {
            ...
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post('/login', this.form).then(function (response) {
                if (response.data.id) {
                    __WEBPACK_IMPORTED_MODULE_0_sweetalert2___default()('Success', 'YAY!', 'success').then(function () {
                        window.location.href = "/dashboard";
                    });
                } else if (response.data == 0) {
                    __WEBPACK_IMPORTED_MODULE_0_sweetalert2___default()('Error', 'Something is wrong...', 'error');
                }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        submitForm: function submitForm() {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('/register', this.form).then(function (response) {
                if (response.data.id) {
                    __WEBPACK_IMPORTED_MODULE_1_sweetalert2___default()('Success', 'YAY!', 'success').then(function () {
                        window.location.href = "/dashboard";
                    });
                } else if (response.data == 0) {
                    __WEBPACK_IMPORTED_MODULE_1_sweetalert2___default()('Error', 'Something is wrong...', 'error');
                }
            }).catch(function (errors) {
                _this.errors = errors.response.data.errors;
            });
...
Component.options.__file = "resources\\assets\\js\\components\\RegisterChooser.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-11e19a1e", Component.options)
  } else {
    hotAPI.reload("data-v-11e19a1e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
  ...
  return _c(
    ...
    [
      _c(
        ...
        [_vm._v(_vm._s(_vm.company ? "User" : "Company"))]
      ),
      _vm._v(" "),
      _vm.company ? _c("register-company") : _vm._e(),
      _vm._v(" "),
      !_vm.company ? _c("register") : _vm._e()
    ],
    1
  )
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-11e19a1e", module.exports)
  }
}
...
/* scopeId */
var __vue_scopeId__ = "data-v-2db471f1"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
var update = __webpack_require__(6)("08626bd2", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-2db471f1\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Projects.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-2db471f1\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Projects.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        showProject: function showProject(id) {
            __WEBPACK_IMPORTED_MODULE_1__app__["default"].$emit('project', this.projects.data[id]);
        },
        startTimer: function startTimer(id) {
            __WEBPACK_IMPORTED_MODULE_1__app__["default"].$emit('project-timer-start', this.projects.data[id]);
        },
        stopTimer: function stopTimer(id) {
            __WEBPACK_IMPORTED_MODULE_1__app__["default"].$emit('project-timer-stop', this.projects.data[id]);
        }
    },
    mounted: function mounted() {
        var _this2 = this;
        ...
        this.getProjects();
        if (Object.keys(this.current_project).length && this.current_project.task_id && Object.keys(this.current_project.task).length && this.current_project.task && Object.keys(this.current_project.task.project).length && this.current_project.task.project.id) {
            this.tickingProject = this.current_project.task.project.id;
        }
        __WEBPACK_IMPORTED_MODULE_1__app__["default"].$on('tzikalo', function (payload) {
            if (payload.project) {
                _this2.tickingProject = payload.project;
            } else {
                _this2.tickingProject = null;
            }
        });
    }
});
  ...
  return _c("div", [
    _vm.isLoading
      ? _c("div", { staticClass: "text-center" }, [
          _c("i", { staticClass: "fa fa-spinner fa-pulse fa-4x" })
        ])
      : _vm._e(),
    _vm._v(" "),
    !_vm.isLoading
      ? _c("table", { staticClass: "table table-bordered" }, [
          _c(
            "tbody",
            _vm._l(_vm.projects.data, function(project, key) {
              return _c("tr", { key: key }, [
                _c("td", [
                  !_vm.tickingProject
                    ? _c("i", {
                        staticClass: "fa fa-play-circle-o click",
                        on: {
                          click: function($event) {
                            $event.preventDefault()
                            _vm.startTimer(key)
                    ...
                    : _vm._e(),
                  _vm._v(" "),
                  _vm.tickingProject && _vm.tickingProject == project.id
                    ? _c("i", {
                        staticClass: "fa fa-pause-circle-o click",
                        on: {
                          click: function($event) {
                            $event.preventDefault()
                            _vm.stopTimer(key)
                  ...
                  _vm._v(" "),
                  _vm.tickingProject && _vm.tickingProject != project.id
                    ? _c("i", { staticClass: "fa text-muted fa-circle-o" })
                    : _vm._e(),
                  _vm._v("\n                      \n                    "),
                  _c(
                    "a",
                    ...
                    [
                      ...
                      _c(
                        "span",
                        {
                          class:
                            "label label-" +
                            (project.tasks.length ? "success" : "danger") +
                            " pull-right"
                        },
                        [
                          _vm._v(
      ...
      : _vm._e(),
    _vm._v(" "),
    _vm.projects.last_page != 1
      ? _c("div", { staticClass: "text-center" }, [
          _c(
            "ul",
            { staticClass: "pagination" },
            [
              _vm.projects.current_page != 1
                ? _c("li", [
                    _c(
                      "a",
                      {
                        ...
                        on: {
                          click: function($event) {
                            $event.preventDefault()
                            _vm.getProjects(
                              parseInt(_vm.projects.current_page) - 1
                            )
                          }
                        }
                      },
                ...
                : _vm._e(),
              _vm._v(" "),
              _vm._l(_vm.projects.last_page, function(page) {
                return _c("li", [
                  _vm.projects.current_page != page
                    ? _c(
                        "a",
                        {
                          attrs: { href: "#" },
              ...
              _vm._v(" "),
              _vm.projects.current_page != _vm.projects.last_page
                ? _c("li", [
                    _c(
                      "a",
                      {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        showTimeframes: function showTimeframes(id) {
            __WEBPACK_IMPORTED_MODULE_0__app__["default"].$emit('task', this.project.tasks[id]);
        }
    },
    mounted: function mounted() {
        var _this = this;

        __WEBPACK_IMPORTED_MODULE_0__app__["default"].$on('project', function (payload) {
            _this.project = payload;
        });
    }
});
...
var render = function() {
  ...
  return _c("div", [
    ...
    _vm._v(" "),
    _vm.project && _vm.project.tasks && _vm.project.tasks.length
      ? _c(
          "ul",
          ...
          [
            _c(
              "transition-group",
              { attrs: { name: "list", duration: 3000 } },
              _vm._l(_vm.project.tasks, function(task, key) {
                return _c(
                  "li",
                  {
                    key: key,
...
Component.options.__file = "resources\\assets\\js\\components\\TimeFrames.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-44f33f0a", Component.options)
  } else {
    hotAPI.reload("data-v-44f33f0a", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        toTimeframe: function toTimeframe(seconds) {
    ...
    mounted: function mounted() {
        ...
        __WEBPACK_IMPORTED_MODULE_0__app__["default"].$on('task', function (payload) {
            _this.task = payload;
        });
    }
});
...
var render = function() {
  ...
  return _c("div", [
    ...
    _vm._v(" "),
    _vm.task && _vm.task.timeframes && _vm.task.timeframes.length
      ? _c(
          "ul",
          { staticClass: "list-unstyled" },
          [
            _c(
              "transition-group",
              { attrs: { name: "list", duration: 3000 } },
              _vm._l(_vm.task.timeframes, function(timeframe, key) {
                      ...
                      _c("div", { staticClass: "pull-right" }, [
                        _c("strong", [
                          _vm._v(
                            _vm._s(
                              _vm.toTimeframe(
                                timeframe.timer_finished -
                                  timeframe.timer_started
                              )
                            )
                          )
                        ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-44f33f0a", module.exports)
  }
}
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-6b8ebfde"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("25ee4d90", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-6b8ebfde\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Timer.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-6b8ebfde\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Timer.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.timer[data-v-6b8ebfde]{\n    background: #FF0000;\n    color:#FFF;\n    font-size:34px;\n}\n.click[data-v-6b8ebfde]{\n    cursor:pointer;\n}\n.click[data-v-6b8ebfde]:hover{\n    color: rgba(255,255,255,0.8) !important;\n}\n.infoWindow[data-v-6b8ebfde]{\n    position:absolute;\n    z-index:-10;\n    background: #FFFFFF;\n    border-radius: 0px 0px 10px 10px;\n    -webkit-box-shadow: 0px 0px 20px #CECECE;\n            box-shadow: 0px 0px 20px #CECECE;\n    padding:20px;\n}\n", ""]);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        toggleBillable: function toggleBillable() {
        ...
        startTimer: function startTimer() {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('/napi/startTimer').then(function (response) {
                if (response.data.id) {
                    _this.timeframe = response.data;
                    _this.tickTack();
                }
            }).catch(function (errors) {
                console.log(errors.response.data);
        ...
        tickTack: function tickTack() {
            var _this2 = this;

            this.tt = setInterval(function () {
                _this2.seconds_from_start += 1;
            }, 1000);
        },
        updateTimer: function updateTimer() {
            var _this3 = this;

            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.put('/napi/updateTimer', { "timeframe": this.timeframe, "form": this.form }).then(function (response) {
                if (response.data.id) {
                    _this3.toggleInfoWindow();
                }
            }).catch(function (errors) {
                console.log(errors);
            });
        ...
        stopTimer: function stopTimer() {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.put('/napi/stopTimer/' + this.timeframe.id).then(function (response) {
                if (response.data.timer_finished) {
                    _this4.timeframe = response.data;
                    _this4.resetTimer();
                }
            }).catch(function (errors) {
                console.log(errors.response.data);
        ...
        timeToISO: function timeToISO(seconds) {
            var date = new Date(null);
            date.setSeconds(seconds);
            return date.toISOString().substr(11, 8);
        },
        positionInfoWindow: function positionInfoWindow() {
            var currentWidth = $('.infoWindow').width();
            if (window.innerWidth > currentWidth * 4) {
                $('.infoWindow').css('width', currentWidth * 4);
                var rightSideOfInfoWindow = -3 * currentWidth + 40;
        ...
        getTasks: function getTasks() {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('/napi/listTasks/' + this.form.project).then(function (response) {
                _this5.tasks = response.data;
                if (Object.keys(_this5.tasks).length && _this5.tasks[0] && _this5.tasks[0].id) {
                    _this5.form.task = _this5.tasks[0].id;
                }
            }).catch(function (errors) {
                console.log(errors.response.data);
            });
    ...
    mounted: function mounted() {
        ...
        __WEBPACK_IMPORTED_MODULE_1__app__["default"].$on('project-timer-start', function (payload) {
            _this6.startTimer();
            _this6.timerStarted = true;
            _this6.form.project = payload.id;
            _this6.getTasks();
            _this6.toggleInfoWindow();
            __WEBPACK_IMPORTED_MODULE_1__app__["default"].$emit('tzikalo', { "project": _this6.form.project });
        });
        __WEBPACK_IMPORTED_MODULE_1__app__["default"].$on('project-timer-stop', function (payload) {
            _this6.stopTimer();
            _this6.timerStarted = false;
            _this6.form = {};
            __WEBPACK_IMPORTED_MODULE_1__app__["default"].$emit('tzikalo', { "project": null });
        });
      ...
      _c("ul", { staticClass: "list-unstyled list-inline" }, [
        ...
        _c("li", [
          _c(
            ...
            {
              domProps: {
                textContent: _vm._s(_vm.timeToISO(_vm.seconds_from_start))
              }
            },
            [_vm._v("00:00")]
          )
      ...
      _c("form", [
        ...
        _c("div", { staticClass: "form-group" }, [
          _c(
            ...
            _vm._l(this.tasks, function(task) {
              return _c("option", { domProps: { value: task.id } }, [
        ...
        _c("div", { staticClass: "form-group" }, [
          _c("textarea", {
            ...
            staticClass: "form-control",
            attrs: { placeholder: "Input task description..." },
        ...
        _c(
          "div",
          {
            staticClass: "form-group click",
            on: {
              click: function($event) {
                $event.preventDefault()
                return _vm.toggleBillable($event)
              }
            }
          },
          [
            _c("i", {
              class:
                "fa " + (_vm.form.billable ? "text-success" : "") + " fa-dollar"
            }),
            _vm._v(" Billable\n            ")
          ]
        ),
          ...
          ? _c("div", { staticClass: "form-group" }, [
              _c(
                "label",
                {
                  ...
                  attrs: { for: "price_per_hour" }
                },
                [_vm._v("Price per hour")]
              ),
              _vm._v(" "),
              _c("input", {
                directives: [
                  {
                    name: "model",
                    rawName: "v-model",
                    value: _vm.form.price_per_hour,
                    expression: "form.price_per_hour"
                  }
                ],
                staticClass: "form-control",
                attrs: { type: "number", min: "0", id: "price_per_hour" },
                domProps: { value: _vm.form.price_per_hour },
                on: {
                  input: function($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.$set(_vm.form, "price_per_hour", $event.target.value)
                  }
                }
              })
            ])
...
var staticRenderFns = [
  function() {
    ...
    return _c("li", [
      _c("i", {
        staticClass: "align-middle fa fa-chevron-circle-down",
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-1a43eff6"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "resources\\assets\\js\\components\\ChangeAvatarka.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1a43eff6", Component.options)
  } else {
    hotAPI.reload("data-v-1a43eff6", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("e418912c", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-1a43eff6\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./ChangeAvatarka.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-1a43eff6\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./ChangeAvatarka.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        photoHasBeenChosen: function photoHasBeenChosen() {
            var _this = this;
            ...
            reader.onloadend = function () {
                ...
                __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('/user/savephoto', { 'file': image }).then(function (response) {
                    if (Object.keys(response.image).length) {
                        _this.avt = response.data.image.profile.url;
                    }
                });
            };
            if (file) {
...
var render = function() {
  ...
  return _c("div", [
      ...
      [
        _c("img", {
          ...
          attrs: {
            src: this.avt
              ? this.avt
              : "http://placehold.it/300x300?text=Avatarka",
            alt: ""
          }
        })
      ]
    ...
    _c("input", {
      ...
      on: { change: _vm.photoHasBeenChosen }
    })
  ])
}
var staticRenderFns = []
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-1a43eff6", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\components\\RegisterForm\\RegisterFormHandler.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-10129445", Component.options)
  } else {
    hotAPI.reload("data-v-10129445", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
        ...
        directives: [
          {
            name: "show",
            rawName: "v-show",
            value: _vm.steps.currentStep == 1,
            expression: "steps.currentStep == 1"
          }
        ],
        attrs: { info: _vm.steps }
      }),
      _vm._v(" "),
      _c("choose-plan", {
        directives: [
          {
            name: "show",
            rawName: "v-show",
            value: _vm.steps.currentStep == 2,
            expression: "steps.currentStep == 2"
          }
        ],
        attrs: { info: _vm.steps }
      }),
        ...
        directives: [
          {
            name: "show",
            rawName: "v-show",
            value: _vm.steps.currentStep == 3,
            expression: "steps.currentStep == 3"
          }
        ],
        attrs: { info: _vm.steps }
      }),
      _vm._v(" "),
      _c("finish-registration", {
        directives: [
          {
            name: "show",
            rawName: "v-show",
            value: _vm.steps.currentStep == 4,
            expression: "steps.currentStep == 4"
          }
        ],
        attrs: { info: _vm.steps }
      })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-10129445", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\components\\RegisterForm\\ChoosePlan.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6b276d4e", Component.options)
  } else {
    hotAPI.reload("data-v-6b276d4e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var staticRenderFns = [
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("ul", [
      _c("li", [_vm._v("Benefit #1")]),
      _vm._v(" "),
      _c("li", [_vm._v("Benefit #2")]),
      _vm._v(" "),
      _c("li", [_vm._v("Benefit #3")]),
      _vm._v(" "),
      _c("li", [_vm._v("Benefit #4")]),
      _vm._v(" "),
      _c("li", [_vm._v("Benefit #5")])
    ])
  },
  function() {
    var _vm = this
    ...
    var _c = _vm._self._c || _h
    return _c("ul", [
      _c("li", [_vm._v("Benefit #6")]),
      _vm._v(" "),
      _c("li", [_vm._v("Benefit #2")]),
      _vm._v(" "),
      _c("li", [_vm._v("Benefit #9")]),
      _vm._v(" "),
      _c("li", [_vm._v("Benefit #4")]),
      _vm._v(" "),
      _c("li", [_vm._v("Benefit #10")])
    ])
  }
]
render._withStripped = true
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6b276d4e", module.exports)
  }
}
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-5a22f888"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "resources\\assets\\js\\components\\RegisterForm\\Payment.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5a22f888", Component.options)
  } else {
    hotAPI.reload("data-v-5a22f888", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("8d7e0150", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5a22f888\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Payment.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5a22f888\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Payment.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.StripeElement[data-v-5a22f888] {\n    background-color: white;\n    height: 40px;\n    padding: 10px 12px;\n    border-radius: 4px;\n    border: 1px solid transparent;\n    -webkit-box-shadow: 0 1px 3px 0 #e6ebf1;\n            box-shadow: 0 1px 3px 0 #e6ebf1;\n    -webkit-transition: box-shadow 150ms ease;\n    -webkit-transition: -webkit-box-shadow 150ms ease;\n    transition: -webkit-box-shadow 150ms ease;\n    transition: box-shadow 150ms ease;\n    transition: box-shadow 150ms ease, -webkit-box-shadow 150ms ease;\n}\n.StripeElement--focus[data-v-5a22f888] {\n    -webkit-box-shadow: 0 1px 3px 0 #cfd7df;\n            box-shadow: 0 1px 3px 0 #cfd7df;\n}\n.StripeElement--invalid[data-v-5a22f888] {\n    border-color: #fa755a;\n}\n.StripeElement--webkit-autofill[data-v-5a22f888] {\n    background-color: #fefde5 !important;\n}\n", ""]);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        createToken: function createToken(event) {
            var _this = this;
        ...
        stripeTokenHandler: function stripeTokenHandler(token) {
            ...
            this.isLoading = true;
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('/napi/subscribe', {
                'token': token.id,
                ...
                if (response.data.id) {
                    __WEBPACK_IMPORTED_MODULE_1_sweetalert2___default()('Success', 'Thanks for your payment', 'success').then(function () {
                        _this2.info.currentStep += 1;
                    });
                }
            }).catch(function (errors) {
                console.log(errors.response.data);
...
var render = function() {
  ...
  return _c("span", [
    ...
    _c(
      "form",
      {
        attrs: { action: "#", method: "post", id: "payment-form" },
        on: {
          submit: function($event) {
            $event.preventDefault()
            return _vm.createToken($event)
          }
        }
      },
      [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-5a22f888", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\components\\RegisterForm\\FinishRegistration.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-9e7a774c", Component.options)
  } else {
    hotAPI.reload("data-v-9e7a774c", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c("span", { staticClass: "text-center" }, [
    _c("h2", [_vm._v("Registration finished")]),
    _vm._v(" "),
    _c(
      "a",
      {
        ...
        on: {
          click: function($event) {
            $event.preventDefault()
            return _vm.to_site($event)
          }
        }
      },
      [_vm._v("Take me to the site!")]
    )
  ])
}
var staticRenderFns = []
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-9e7a774c", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\components\\CompanyRegister.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-39e64fce", Component.options)
  } else {
    hotAPI.reload("data-v-39e64fce", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        submitForm: function submitForm() {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('/registerCompany', this.form).then(function (response) {
                if (response.data.company && response.data.company.id) {
                    _this.info.company = response.data;
                    _this.info.currentStep += 1;
                } else if (response.data == 0) {
                    __WEBPACK_IMPORTED_MODULE_1_sweetalert2___default()('Error', 'Something is wrong...', 'error');
                }
            }).catch(function (errors) {
...
var render = function() {
  ...
  return _c("form", [
    ...
    _vm._v(" "),
    _c("div", { staticClass: "form-group" }, [
      _c("label", { attrs: { for: "company_name" } }, [_vm._v("Company name")]),
      _vm._v(" "),
      _c("input", {
        directives: [
          {
        ...
        staticClass: "form-control",
        attrs: { type: "text", id: "company_name" },
    ...
    _vm._v(" "),
    _c("div", { staticClass: "form-group" }, [
      _c("label", { attrs: { for: "company_number" } }, [
      ...
      _c("input", {
        ...
        staticClass: "form-control",
        attrs: { type: "text", id: "company_number" },
        domProps: { value: _vm.form.company_number },
        on: {
          keyup: _vm.cleanErrors,
          input: function($event) {
            if ($event.target.composing) {
            ...
            _vm.$set(_vm.form, "company_number", $event.target.value)
          }
        }
      }),
      _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-39e64fce", module.exports)
  }
}
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-25f7e479"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "resources\\assets\\js\\components\\CreateElement.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-25f7e479", Component.options)
  } else {
    hotAPI.reload("data-v-25f7e479", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("5d059a9e", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-25f7e479\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./CreateElement.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-25f7e479\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./CreateElement.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-25f7e479", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\components\\AddProjectForm.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2b1cdd53", Component.options)
  } else {
    hotAPI.reload("data-v-2b1cdd53", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getClientsList: function getClientsList() {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('/napi/clientslist').then(function (response) {
        ...
        submitForm: function submitForm() {
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('/napi/saveProject', this.form).then(function (response) {
                if (response.data.id) {
                    __WEBPACK_IMPORTED_MODULE_1_sweetalert2___default()('success', 'Prohect saved', 'success').then(function () {
                        $('.wrapper').toggleClass('active-sidebar');
                    });
                } else {
                    __WEBPACK_IMPORTED_MODULE_1_sweetalert2___default()('Error', 'We are totally Fucked...', 'error');
                }
            }).catch(function (errors) {
                console.log(errors.response.data);
            });
    ...
    _c("span", [
      ...
      _c("form", { attrs: { action: "#", method: "post" } }, [
        ...
        _c("div", { staticClass: "form-group" }, [
          _c(
            "label",
            { staticClass: "control-label", attrs: { for: "client" } },
            [_vm._v("Client")]
          ),
          _vm._v(" "),
          _c(
            ...
            [
              ...
              _vm._v(" "),
              _vm._l(this.clients, function(name, id) {
        ...
        _c("div", { staticClass: "form-group" }, [
          _c(
            "label",
            { staticClass: "control-label", attrs: { for: "estimation" } },
            [_vm._v("Estimation")]
          ),
          _vm._v(" "),
          _c("input", {
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.form.estimation,
                expression: "form.estimation"
              }
            ],
            staticClass: "form-control",
            attrs: { type: "text", name: "estimation", id: "estimation" },
            domProps: { value: _vm.form.estimation },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.$set(_vm.form, "estimation", $event.target.value)
              }
            }
          })
        ]),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2b1cdd53", module.exports)
  }
}
